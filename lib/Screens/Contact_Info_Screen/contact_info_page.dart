...
import 'package:resumebuilder/Globals/globals.dart';
      ...
      body: Column(
        children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Container(
                                color: (initialIndex == 0) ? Colors.yellow : MyColor,
                                height: 2,
                              ),
                            ],
                          ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Spacer(),
                              Container(
                                color: (initialIndex == 1) ? Colors.yellow : MyColor,
                                height: 2,
                              ),
                            ],
                          ),
          ...
          Expanded(
            flex: 18,
            child: Container(
              decoration: BoxDecoration(color: const Color(0xffEDEDED), borderRadius: BorderRadius.circular(10.r)),
              child: IndexedStack(
                index: initialIndex,
                children: [
                            ...
                            showDialog(
                              ...
                              builder: (context) => AlertDialog(
                                ...
                                actions: [
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      XFile? pickerFile = await _picker.pickImage(source: ImageSource.camera);
                                      setState(() {
                                        Global.image = File(pickerFile!.path);
                                        Navigator.of(context).pop();
                                      });
